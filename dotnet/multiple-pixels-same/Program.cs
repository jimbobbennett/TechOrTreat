...
// Learn more: https://docs.microsoft.com/dotnet/csharp/fundamentals/program-structure/top-level-statements?WT.mc_id=academic-47288-cxa
...
for(int x = 0; x < ledCount; ++x) {
    device.Image.SetPixel(x, 0, Color.Red);
}
